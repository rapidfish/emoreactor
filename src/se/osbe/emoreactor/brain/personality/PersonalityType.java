...
public enum PersonalityType {
	...
	FEELING("Feeling: Making decisions from a personal perspective. In Jung's typology, feeling is a rational function. Feeling's opposite is Thinking."),
	THINKING("Thinking: Making decisions impersonally. In Jung's typology, thinking is a rational function. Thinking's opposite is Feeling."),
